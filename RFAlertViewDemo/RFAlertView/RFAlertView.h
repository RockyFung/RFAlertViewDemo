...
typedef NS_ENUM(NSInteger , RFShowAnimationStyle) {
    RFShowAnimationDefault    = 0,
    RFShowAnimationLeftShake  ,
    RFShowAnimationTopShake   ,
    RFShowAnimationNO         ,
};

typedef void(^RFAlertClickIndexBlock)(NSInteger clickIndex);


@interface RFAlertView : UIView

@property (nonatomic, copy)RFAlertClickIndexBlock clickBlock;

@property (nonatomic, assign)RFShowAnimationStyle animationStyle;
